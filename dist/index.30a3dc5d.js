...
})({"fFLLL":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "cbea842930a3dc5d";
"use strict";
...
},{}],"dlVAF":[function(require,module,exports) {
// WebSocket
...
window.onload = async ()=>{
    try {
        await (0, _socketJs.connectWebSocket)();
        await (0, _socketJs.fetchData)("hobbit.json");
        setupEventListeners();
    } catch (error) {
...
},{"./socket.js":"1hJD6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fFLLL","dlVAF"], "dlVAF", "parcelRequire36f5")

//# sourceMappingURL=index.30a3dc5d.js.map
