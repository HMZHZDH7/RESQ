...
const Navbar = ({ sections }: NavbarProps) => {
    ...
    return (
        <div className="fixed left-[20px] top-0 w-[400px] h-screen flex flex-col items-center justify-center pt-[100px] pb-[200px] z-40">
            <div className="w-full h-full rounded-[15px] flex flex-col items-center gap-[20px] px-[30px] py-[15px] bg-primary shadow-[0px_3.5px_5.5px_0px_rgba(0,_0,_0,_0.02)]">

                <div className="w-full rounded-[15px] flex flex-col items-center py-[5px] bg-[#09101b66]">
                ...
                <nav className="scrollable-container no-scrollbar relative w-full flex-grow flex flex-col items-center overflow-auto">
                    <div className="up-arrow sticky top-0 w-full flex justify-center h-[10px] bg-gradient-to-b from-primary to-transparent">
